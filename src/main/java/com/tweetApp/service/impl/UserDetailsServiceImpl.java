...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    @Override
    public UserDetails getRegistrationDetails() throws FieldIsRequiredException {
        ...
        if(firstName.isEmpty() || firstName==null){
            throw new FieldIsRequiredException("Please enter valid first name");
        }else{
        ...
        if(gender.isEmpty() || gender==null){
            throw new FieldIsRequiredException("Please enter valid gender");
        }else{
            if(gender.equalsIgnoreCase("M") || gender.equalsIgnoreCase("F"))
            {  newUser.setGender(gender);
            }else{
                throw new FieldIsRequiredException("Please select between (M / F)");
            }
        }
        ...
        if(dateOfBirth.isEmpty() || dateOfBirth==null){
            ...
            try {
                ...
                throw new FieldIsRequiredException("Please enter date in valid format");
            }
        }
        ...
        if(email.isEmpty() || email==null){
            throw new FieldIsRequiredException("Please enter valid email id");
        }else{
        ...
        if(password.isEmpty() || password==null){
            throw new FieldIsRequiredException("Please enter valid password");
        }else{
